        ...
        <nav class="flex-1 overflow-y-auto py-4 relative z-20 sidebar-nav pt-3">
            <div class="px-3 space-y-1">
                ...
                <a href="{{ route('dashboard.reseller') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 btn-small {{ request()->routeIs('dashboard.reseller') ? 'bg-primary text-white shadow-lg' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                ...
                <a href="{{ route('reseller.users') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 btn-small {{ request()->routeIs('reseller.users*') ? 'bg-primary text-white shadow-lg' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                    </svg>
                    <span class="font-medium text-sm">My Users</span>
                </a>

                <!-- Payments -->
                <a href="{{ route('reseller.payments') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 btn-small {{ request()->routeIs('reseller.payments*') ? 'bg-primary text-white shadow-lg' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Transactions -->
                <a href="{{ route('reseller.transactions') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 btn-small {{ request()->routeIs('reseller.transactions*') ? 'bg-primary text-white shadow-lg' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('reseller.sell') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 btn-small {{ request()->routeIs('reseller.sell*') ? 'bg-primary text-white shadow-lg' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Buy Requests -->
                <a href="{{ route('reseller.buy-requests') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 btn-small {{ request()->routeIs('reseller.buy-requests*') ? 'bg-primary text-white shadow-lg' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                    </svg>
                    <span class="font-medium text-sm">Buy Requests</span>
                </a>

                @if(auth()->user()->kyc_status === 'approved' && auth()->user()->token_balance > 0)
                <!-- Earn RWAMP Coin -->
                <a href="{{ route('game.select') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 btn-small {{ request()->routeIs('game.*') ? 'bg-primary text-white shadow-lg' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span class="font-medium text-sm">Earn RWAMP Coin</span>
                </a>
                @endif
