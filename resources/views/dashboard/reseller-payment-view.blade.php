        ...
        <div class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-30">
            <div class="px-4 sm:px-6 lg:px-8 py-5">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl md:text-3xl font-montserrat font-bold text-gray-900">Payment Details</h1>
                        <p class="text-gray-500 text-sm mt-1.5">View complete payment information</p>
                    </div>
                    <div class="flex gap-3">
                        <button onclick="sharePaymentDetails()" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors text-sm">
                            📋 Share Details
                        </button>
                    </div>
                </div>
