    ...
    <section class="bg-gradient-to-r from-black to-secondary text-white py-12">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex items-center justify-between flex-wrap gap-4">
                <div>
                    <h1 class="text-3xl md:text-5xl font-montserrat font-bold">User Details</h1>
                    <p class="text-white/80">View complete user information</p>
                </div>
                <div class="flex gap-3">
                    <button onclick="shareUserDetails()" class="bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors">
                        📋 Share Details
                    </button>
